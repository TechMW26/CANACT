...
export function ProfileCompletionPrompt() {
  ...
  return (
    <>
      <div className="fixed inset-x-4 bottom-[calc(var(--canact-floating-bottom-clearance)+10px)] z-[85] mx-auto max-w-md rounded-[24px] border border-[#E4E7E2] bg-white p-3 shadow-[0_18px_50px_rgba(15,23,42,0.16)]">
