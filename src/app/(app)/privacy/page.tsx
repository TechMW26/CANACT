    ...
    <main className="space-y-3 py-4">
      <Card>
        ...
        <div className="mt-5 space-y-4 text-sm leading-6 text-ink/75">
          <section><h2 className="font-extrabold text-ink">Data Canact uses</h2><p>Canact processes account and profile details, content, connections, community interactions, device notification tokens, and location when you enable nearby features. Identity verification stores verification status and the last four digits of the submitted identifier, not the full number.</p></section>
